...
# ==========================================
st.set_page_config(page_title="LxU 关键词提炼工具-最新版", layout="wide")
st.title("⚡ LxU 关键词提炼与广告策略工具 (2.5 极速版)")
...
if files and st.button("🚀 开始批量深度提炼"):
    ...
    try:
        ...
        for i, file in enumerate(files):
            ...
            try:
                with st.spinner('⚡ Gemini 2.5 正在扫描大文件，请稍候...'):
                    # 针对大文件的上传处理
